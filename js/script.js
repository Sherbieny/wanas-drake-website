...
$(document).ready(function($) {
	...
	/*	Contact Map
	/* ---------------------------------------------------------------------- */
	var contact = { "lat": "29.975075", "lon": "31.279067" }; //Change a map coordinate here!
	...
	try {
		...
		mapContainer.gmap3({
			...
			marker:{
				options:{
					icon : new google.maps.MarkerImage('images/logo.png')
				}
			},
			latLng: [contact.lat, contact.lon],
			map:{
				options:{
				    center: [29.975075, 31.299067],//Change a map coordinate here!
					zoom: 14
				}
				},
			},
...
$(function () {
    ...
    $('#passRecover_cancel').click(function (e) {
        $("#login-form").delay(100).fadeIn(100);
        $("#login-form-link").fadeIn(100);
        $("#register-form-link").fadeIn(100);
