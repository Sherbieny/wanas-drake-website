<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectSingleView.aspx.cs" Inherits="ProjectSingleView" %>

<!DOCTYPE html>

<html lang="en" class="no-js">
<head runat="server">
    <title>WDI | Project</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
            <!-- Header
		    ================================================== -->
            <header class="fixit" style="border-right-color: grey; border-right-width: 0.2vw; border-right-style: solid">
                ...
                <div class="menu-box">
                    <ul class="menu">
                        ...
                        <%--<li>
                            <a class="active" href="Categories.aspx"><span>Projects</span></a>                           
                        </li>--%>
                        ...
                        <div class="single-project">
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <asp:PlaceHolder ID="indicators" runat="server"></asp:PlaceHolder>
                                </ol>
                                

                                 <!-- Wrapper for slides -->
                                <div class="carousel-inner">
                                    <asp:PlaceHolder ID="Wrapper" runat="server"></asp:PlaceHolder>
                                </div>
